...
const C = {
  ...
  primaryPhone: "+381648222625",
  primaryPhoneDisplay: "+381 64 822 26 25",
  secondaryPhone: "+381113757288",
  secondaryPhoneDisplay: "+381 11 375 72 88",
  email: "vezmar.bojana@eef.rs",
  ...
  whatsapp: "https://wa.me/381648222625?text=Hello%2C%20I%20got%20your%20contact%20from%20QR%20code.",
};

const UI = {
  sr: {
    langLabel: "Jezik",
    position: "Referent prodaje",
    ...
    shareTitle: "Bojana Vezmar | EKO Elektrofrigo",
    shareText: "Referent prodaje – EKO Elektrofrigo\nRashladni sistemi • Klimatizacija • CA komore",
    vcfTitle: "Referent prodaje",
    vcfNote: "Vaš partner od 1996...",
    vcfFileName: "Bojana_Vezmar_EKO_SR.vcf",
  },
  en: {
    langLabel: "Language",
    position: "Sales Associate",
    ...
    shareTitle: "Bojana Vezmar | EKO Elektrofrigo",
    shareText: "Sales Associate – EKO Elektrofrigo\nRefrigeration • Air Conditioning • CA Rooms",
    vcfTitle: "Sales Associate",
    vcfNote: "Your partner since 1996...",
    vcfFileName: "Bojana_Vezmar_EKO_EN.vcf",
  },
} as const;
